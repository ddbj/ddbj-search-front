...
import { metaboBankDetailRequestDoc } from "@/api/detail/metaboBank.ts";
...
import { geaListRequestDoc } from "@/api/entries/gea.ts";
...
import { metaboBankListRequestDoc } from "@/api/entries/metaboBank.ts";
...
import { geaFacetListRequestDoc } from "@/api/facets/gea.ts";
...
import { metaboBankFacetListRequestDoc } from "@/api/facets/metaboBank.ts";
