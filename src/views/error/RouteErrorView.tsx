...
const getRouteErrorViewModel = (title: string, statusCode?: number, error?: unknown) => {
...
export const RouteErrorView: FC<Props> = ({
  statusCode,
  title,
  description,
  actionLabel,
  ...
  const {
    ...
    requestId,
    errorMessage,
  } = getRouteErrorViewModel(title, statusCode, error);
...
export const __TEST__RouteErrorView = {
  formatDisplayTitle,
  getRouteErrorViewModel,
};
